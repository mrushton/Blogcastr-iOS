...
- (void) authorize
{
  ...
  [data setLength:0];
  self.urlConnection = [NSURLConnection connectionWithRequest:postRequest
		   delegate:self];
}
...
- (void)connection:(NSURLConnection *)connection didFailWithError:(NSError *)theEerror
{
  self.urlConnection = nil;
  self.error = TwitterXAuthConnectionError;  
